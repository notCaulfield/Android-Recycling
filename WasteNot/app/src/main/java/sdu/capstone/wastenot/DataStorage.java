...
public class DataStorage {
    ...
    private void init(Context context) {
        shinglesInit(context);
        bricksInit(context);
        batteriesInit(context);
        cardboardInit(context);
        elecInit(context);
        lampsInit(context);
        organicsInit(context);
        glassInit(context);
        gypsumInit(context);
        tonersInit(context);
        metalsInit(context);
    ...
    private void cardboardInit(Context context) {
        ...
        cardboard.add(new Center("Secondary Solutions", "P.O. Box 727\n" +
                ...
                "(301) 797-4237",  "ssolut1121@aol.com", null, context) );
        cardboard.add(new Center("Simkins Industries, Inc.", "201 River Road \n" +
                "P.O. Box 3249 \n" +
                "Catonsville, MD 21228",
                "(410) 747-5100",  null, null, context) );
        cardboard.add(new Center("The Owl Corporation", "1900 Graves Court\n" +
                "Baltimore, MD 21222",
                "(410) 282-0067",  "jlpaperbuyer@aol.com", "www.theowlcorp.com", context) );
    ...
    public void lampsInit(Context context) {
        ...
        fluorescents.add(new Center("Clean Venture, Inc.", "2931 Whittington Avenue\n" +
                "Baltimore, MD 21230",
                "(410) 368-9170",  null, "www.chclechem.com", context) );
        ...
        fluorescents.add(new Center("EQ-The Environmental Quality Company", "3508-B Fairfield Avenue\n" +
                "Baltimore, MD 21226",
                "(410) 354-2221",  null, "www.eqonline.com", context) );
        ...
        fluorescents.add(new Center("Safety Kleen Corporation (Baltimore)", "1448 Desoto Road \n" +
                "Baltimore, MD 21230",
                "(410) 525-0001",  null, null, context) );
    }

    private void organicsInit(Context context) {
    ...
    private void glassInit(Context context) {
        ...
        glass.add(new Center("Design Recycle, Inc.", "4653 Hollins Ferry Road\n" +
                "Halethorpe, MD 21227",
                "(202) 374-4863",  null, null, context) );
        ...
        glass.add(new Center("Harford Sanitation", "440 Franklin Street \n" +
                "Bel Air, MD 21014",
                "(410) 838-5472",  null, null, context) );
        ...
        glass.add(new Center("Montgomery County Material Recovery Facility", "16105 Frederick Avenue \n" +
                "Derwood, MD 20855",
                "(301) 417-1433",  null, null, context) );
        ...
        glass.add(new Center("Soil Safe, Inc.", "6700 Alexander Bell Drive, Suite 300\n" +
                "Columbia, MD 21046",
                "(410) 872-3990",  "info@soilsafe.com", "www.soilsafe.com", context) );
    ...
    private void gypsumInit(Context context) {
    ...
    private void tonersInit(Context context) {
        ...
        toners.add(new Center("Litz Green Recycling", "6655-D Mid Cities Avenue\n" +
                "Beltsville, MD 20705",
                "(240) 241-7623",  "info@litzgr.com", "www.litzgr.wixcom/54321litz#!", context) );
        toners.add(new Center("Printer Solutions", "2137 Defense Highway, Suite 10\n" +
                "Crofton, MD 21114",
                "(301) 858-0470",  "rob@printersolutions.com", null, context) );
        toners.add(new Center("Prism Environmental Group, Inc.", "610 Somerset Road, Suite 103\n" +
                "Baltimore, MD 21210",
                "(410) 433-5804",  "prism@us.net", null, context) );
    ...
    //TODO More here...
    private void metalsInit(Context context) {
        metals.add(new Center("1-800-GOT-JUNK?", "12031 Nebel Street\n" +
                "Rockville, MD 20852",
                "(800) 468-5865",  "baltimore@1800gotjunk.com", null, context) );
        ...
        metals.add(new Center("Auston Contracting, Inc.", "1202 Pauls Lane\n" +
                "Joppa, MD 21085",
                "(410) 335-1016",  null, null, context) );
        metals.add(new Center("B & S Scrap", "182 Fingerboard Road\n" +
                "Oakland, MD 21550",
                "(301) 334-2676",  null, null, context) );
        ...
        metals.add(new Center("Baltimore Scrap Corporation", "3100 Weedon Street \n" +
                "Baltimore, MD 21226",
                "(410) 355-4455",  "jross@baltimorescrap.com", "www.baltimorescrap.com", context) );
        metals.add(new Center("Benjer, Inc.", "P O Box 695\n" +
                "White Marsh, MD 21162",
                "(410) 335-2267",  "benjer@benjerinc.com", null, context) );
        metals.add(new Center("Berg Recycling", "1401 West Hamburg Street \n" +
                "Baltimore, MD 21230",
                "(410) 837-5575",  null, "www.bergrecycling.com", context) );
    ...
    private void oilInit(Context context) {
        ...
        oil.add(new Center("Kroff Materials Reprocessing, Inc.", "4605 Richlynn Drive, Suite 200\n" +
                "Belcamp, MD 21017",
                "(410) 272-3993",  "jcipollone@kroffmr.com", null, context) );
        ...
        oil.add(new Center("USA Oil Refining, LLC", "171 Childs Road\n" +
                "Elkton, MD 21921",
                "(410) 392-0971",  null, null, context) );
        /*
        oil.add(new Center("", "",
                "",  null, null, context) );
        */
    ...
    private void paperInit(Context context) {
        ...
        paper.add(new Center("AAA Secured Shredding Services", "3113 Lauren Hill Drive\n" +
                "Finksburg, MD 21048",
                "(410) 861-8970",  "sales@securedshredding.com", null, context) );
        paper.add(new Center("All-Shred, Inc.", "4831 Winchester Boulevard\n" +
                "Frederick, MD 21703",
                "(301) 874-1480",  "marykulina@allshredmd.com", null, context) );
        ...
        paper.add(new Center("Athelas National Recovery Institute", "9104 Red Branch Road \n" +
                "Columbia, MD 21045",
                "(410) 964-1241",  null, null, context) );
        ...
        paper.add(new Center("Budget Shred", "9475 Gerwig Lane\n" +
                "Columbia, MD 21046",
                "(888) 747-3356",  "info@budgetshred.com", "www.budgetshred.com", context) );
        paper.add(new Center("CH Recycling Company (Baltimore)", "1532 Thames Street\n" +
                "Baltimore, MD 21231",
                "(410) 522-0110",  "jsloan@chrecycling.com", "www.chrecycling.com", context) );
        paper.add(new Center("Cintas Document Management", "6770 Oak Hall Lane, Suite 107\n" +
                "Columbia, MD 21046",
                "(240) 294-0389",  "pelosom@cintas.com", null, context) );
        ...
        paper.add(new Center("CreaFill Fibers Corporation", "10200 Worton Road \n" +
                "Chestertown, MD 21620",
                "(410) 810-0779",  "fiber@cffcorp.com", null, context) );
        ...
        paper.add(new Center("Dutton Avenue Marketing", "6400 Baltimore National Pike \n" +
                "Baltimore, MD 21228",
                "(410) 788-7326",  null, null, context) );
        ...
        paper.add(new Center("Eagle Recycling LLC", "510 West Road\n" +
                "Salisbury, MD 21801",
                "(410) 677-3777",  null, "www.eaglerecyclingllc.net", context) );
        paper.add(new Center("Eastern Recycling, LLC", "5107 North Point Boulevard\n" +
                "Sparrows Point, MD 21219",
                "(410) 477-7500",  null, "www.ersmd.com", context) );
        ...
        paper.add(new Center("Encore Recycling", "13211 Virginia Manor Road\n" +
                "Laurel, MD 20707",
                "(410) 813-2610",  null, null, context) );
        paper.add(new Center("Fibre Marketing Group", "120 Alco Place\n" +
                "Lansdowne, MD 21227",
                "(410) 247-3084",  null, null, context) );
        ...
        paper.add(new Center("Hanna Paper Recycling", "8840 Greenwood Place\n" +
                "Savage, MD 20763",
                "(301) 604-3302",  null, "www.hannapaper.com", context) );
        ...
        paper.add(new Center("Nova Services, Inc.", "2500 Grays Road\n" +
                "Baltimore, MD 21222",
                "(410) 388-2200",  "dkellermann@novarecycles.com", "www.novarecycles.com", context) );
        ...
        paper.add(new Center("Proshred Security", "1550 Caton Center Drive\n" +
                "Baltimore, MD 21227",
                "(410) 242-9224",  null, null, context) );
        ...
        paper.add(new Center("The Shredding Company, Inc.", "9125 Industrial Court\n" +
                ...
                "(301) 845-4499",  "chris@shreddingcompanydc.com", "www.shreddingcompanydc.com", context) );
    }

    private void plasticsInit(Context context) {
        plastics.add(new Center("Advanced Recycling, LLC", "10302 Little Patuxent Parkway, Suite 300\n" +
                "Columbia, MD 21044",
                "(301) 362-1119",  null, null, context) );
        ...
        plastics.add(new Center("C.R. Daniels, Inc.", "3451 Ellicott Center Drive \n" +
                ...
                "(410) 461-2100",  null, null, context) );
        ...
        plastics.add(new Center("Eagle Recycling LLC", "510 West Road\n" +
                "Salisbury, MD 21801",
                "(410) 677-3777",  "kaleb.eagle@gmail.com", "www.eaglerecyclingllc.net", context) );
    ...
    private void textInit(Context context) {
        textiles.add(new Center("Debois Textiles, Inc.", "1835 Washington Boulevard\n" +
                "Baltimore, MD 21230",
                "(800) 769-6399",  null, null, context) );
        ...
        textiles.add(new Center("ROW Clothing Enterprises", "2523 Gwynns Falls Parkway \n" +
                "Baltimore, MD 21216",
                "(410) 523-5340",  null, null, context) );
    }

    private void tiresInit(Context context) {
        ...
        tires.add(new Center("Catalyst & Chemical Systems, Inc. of MD", "2100 Muir Way\n" +
                "Bel Air, MD 21015",
                "(410) 569-1200",  null, null, context) );
        tires.add(new Center("Design Recycle, Inc.", "4653 Hollins Ferry Road\n" +
                "Halethorpe, MD 21227",
                "(202) 374-4863",  "jeiassociates@aol.com", null, context) );
        tires.add(new Center("Emanuel Tire Company", "1300 Moreland Avenue\n" +
                "Baltimore, MD 21216",
                "(410) 947-0725",  null, "www.emanueltire.com", context) );
        tires.add(new Center("Enviro Pro", "1406 Allwood Lane, Suite T3\n" +
                "Belcamp, MD 21017",
                "(855) 900-8473",  "sowens@environmental-pro.com", "www.environmental-pro.com", context) );
        ...
        tires.add(new Center("REC-Creative, Inc.", "2719 Bird View Road\n" +
                ...
                "(410) 876-0848",  null, null, context) );
        tires.add(new Center("Safety Ring", "7300 Pyle Road\n" +
                "Bethesda, MD 20817",
                "(301) 229-7250",  null, null, context) );
        tires.add(new Center("TurboHaul", "11700 Old Baltimore Pike\n" +
                "Beltsville, MD 20705",
                "(301) 931-6993",  null, "kevindaly@turbohaul.com", context) );
    }

    private void palletsInit(Context context) {
        pallets.add(new Center("Blue Ribbon Pallets", "1679 Blue Ribbon Road \n" +
                "Oakland, MD 21550",
                "(301) 334-58100",  null, null, context) );
        ...
        pallets.add(new Center("Butler Tree Service, LLC", "4039 Tuscarora Road\n" +
                ...
                "(301) 607-4541",  "wbwoodrecycling@aol.com", "http://www.butlerwoodrecycling.com", context) );
        ...
        pallets.add(new Center("Valleywood Industries, Inc. / Pallet Masters", "6517 Landay Avenue\n" +
                "Baltimore, MD 21237",
                "(410) 488-5500",  null, null, context) );
    }
